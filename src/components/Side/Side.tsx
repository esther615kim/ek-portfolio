...
const Side = () => {
  return (
    <div>
      <h3 className="lg:mt-20 lg:pt-40 mt-10 text-3xl font-semibold text-white tracking-wider font-oohhbaby">
        Esther Kim
      </h3>
      <p className="hover:text-cyan-300 font-poppins mt-5 mb-20 lg:mb-40 font-medium text-lg ">
        Front End Developer
      </p>
